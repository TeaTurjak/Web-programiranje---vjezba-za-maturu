...
<body>
  ...
  <div class="container-fluid p-lg-5 mt-5 bg-dark text-white " style="width:100%" >
    <h2 class="display-4 p-1">Dobrodošli, srednjoškolci!</h2>
    <p class="display-6">Krajnji je tren za pripreme za maturu! Priduži nam se i rasturi na maturi iz Hrvatskoga jezika!</p>
  </div>
  
  <div class="container-fluid"  style="width:100%" >
  <div class="row align-items-center">
    <div class="col animate__animated animate__fadeIn animate__slow text-center">
